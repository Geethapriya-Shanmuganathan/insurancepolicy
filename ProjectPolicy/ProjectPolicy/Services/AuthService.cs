...
//        new System.Security.Claims.Claim("userType", user.Role.ToString()),
//        new System.Security.Claims.Claim(ClaimTypes.Role, user.Role.ToString()) // REQUIRED for [Authorize(Roles="ADMIN")]
//    };
